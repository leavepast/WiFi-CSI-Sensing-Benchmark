...
def main(args):
    ...
    train_files_path, val_files_path = read_widar_data(args.data_path)
    ...
    # 实例化训练数据集
    train_dataset = MyDataSet(files_path=train_files_path,
                              transform=data_transform["train"])

    # 实例化验证数据集
    val_dataset = MyDataSet(files_path=val_files_path,
